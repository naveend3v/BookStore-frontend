...
export const checkoutCartSessionAPIService = (cartItems) => ApiClient.post('/user/order/create-checkout-session',cartItems);
export const getAllOrdersAPIService = () => ApiClient.get('/user/order/allOrders');
export const placeOrderAPIService = (sessionId) => ApiClient.post('/user/order/add',sessionId);